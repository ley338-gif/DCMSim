...
def test_real_echo_roundtrip():
    ...
    try:
        result = echo({"host": "127.0.0.1", "port": server.server_address[1], "called_ae": "TESTSCP", "calling_ae": "DCMSIM"})
...
def test_real_store_roundtrip():
    ...
    try:
        ...
        result = store_dataset({"host": "127.0.0.1", "port": server.server_address[1], "called_ae": "STORESCP", "calling_ae": "DCMSIM"}, ds)
        assert result["success"] is True
