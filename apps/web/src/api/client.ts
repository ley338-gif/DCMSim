...
export type WorklistChannel={id:number;name:string;area_id:number|null;modality_code:ModalityCode;mwl_endpoint_id:number;station_ae_mode:FilterMode;station_ae_fixed_value:string|null;modality_filter_mode:FilterMode;modality_filter_fixed_value:string|null;created_at:string;updated_at:string}
export type ModalityProfile={id:number;name:string;description:string|null;modality:ModalityCode;calling_ae:string;mwl_enabled:boolean;mwl_target_id:number|null;store_enabled:boolean;store_target_id:number|null;area_id:number|null;worklist_channel_id:number|null;store_endpoint_id:number|null;created_at:string;updated_at:string}
