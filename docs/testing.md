...
- **Frontend:** React Testing Library prüft Target-Auswahl, technische Details und stabile Fehlerdarstellung. Seitenflows decken Formzustände, Nulltreffer und UIDs ab.
